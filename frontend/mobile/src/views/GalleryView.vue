...
<style scoped>
.gallery-heading{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:calc(env(safe-area-inset-top) + 14px) 6px 14px}.gallery-heading>span{color:var(--muted);font-size:9px;white-space:nowrap}
.gallery-tabs{display:flex;gap:4px;padding:4px;border-radius:12px;background:rgba(234,235,244,.72)}.gallery-tabs button{min-height:29px;padding:0 11px;border:0;border-radius:9px;color:#8e8796;background:transparent;font-size:9px}.gallery-tabs button.active{color:#617da4;background:rgba(255,255,255,.92);box-shadow:0 4px 12px rgba(93,91,122,.08)}
...
.gallery-grid{position:relative;z-index:1}.gallery-month>header{display:flex;align-items:baseline;gap:9px;margin-bottom:18px}.gallery-month h2{margin:0;color:#4b4656;font:500 18px/1.2 Georgia,serif;letter-spacing:.03em}.gallery-month header span{color:#a096a4;font-size:8px}
...
.gallery-photo{position:relative;aspect-ratio:3/4;overflow:hidden;background:#e9e5e5}.gallery-photo img{width:100%;height:100%;display:block;object-fit:cover;filter:saturate(.96) contrast(.98)}.gallery-badge{position:absolute;top:6px;left:6px;padding:2px 7px;border-radius:999px;color:#fff;font-size:8px;font-style:normal;backdrop-filter:blur(4px)}.gallery-badge-chat{background:rgba(97,125,164,.82)}.gallery-badge-journal{background:rgba(197,121,158,.82)}.gallery-item time{padding:0 2px;color:#9a919b;font:8px/1.2 Georgia,serif;letter-spacing:.03em}
.gallery-status{position:absolute;z-index:2;right:14px;bottom:18px;left:14px;min-height:34px;display:grid;place-items:center;color:#9a919f;font-size:8px}.gallery-status>button{min-height:31px;padding:0 15px;border:1px solid rgba(105,126,160,.16);border-radius:999px;color:#667fa4;background:rgba(255,255,255,.74)}.gallery-status nav{display:flex;align-items:center;justify-content:center;gap:12px}.gallery-status nav button{width:32px;height:32px;display:grid;place-items:center;padding:0;border:1px solid rgba(105,126,160,.16);border-radius:50%;color:#667fa4;background:rgba(255,255,255,.74)}.gallery-status nav button:disabled{opacity:.3}.gallery-status nav span{min-width:62px;text-align:center}
