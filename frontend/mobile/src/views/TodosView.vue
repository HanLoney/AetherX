...
.todo-tabs{display:grid;grid-template-columns:1fr 1fr;gap:5px;padding:5px;border-radius:18px;background:rgba(111,103,136,.07)}.todo-tabs button{height:42px;border:0;border-radius:14px;color:#8b8597;background:transparent;font-size:11px;font-weight:700}.todo-tabs button.active{color:#58526c;background:rgba(255,255,255,.86);box-shadow:0 8px 20px rgba(86,79,112,.09)}.todo-tabs b{display:inline-grid;place-items:center;min-width:20px;height:20px;margin-left:5px;border-radius:10px;color:#fff;background:linear-gradient(135deg,var(--pink),var(--blue));font-size:9px}
