...
.calendar-toolbar{height:42px;display:grid;grid-template-columns:42px 1fr 42px;align-items:center;gap:8px;margin-bottom:8px}.calendar-toolbar strong{text-align:center;color:#4f4a5f;font-size:16px;letter-spacing:0}.month-button{width:42px;height:42px;display:grid;place-items:center;border:0;border-radius:14px;color:#736d82;background:rgba(255,255,255,.66);box-shadow:inset 0 0 0 1px var(--line)}
.weekday-row,.calendar-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:6px}.weekday-row{margin-bottom:7px}.weekday-row span{height:24px;display:grid;place-items:center;color:#9a94a5;font-size:10px;font-weight:800}
.day-cell{position:relative;aspect-ratio:1;min-width:0;display:grid;place-items:center;border:0;border-radius:8px;color:#5a5567;background:rgba(248,247,252,.72);font-size:12px;font-weight:750;transition:transform .16s ease,box-shadow .16s ease,background .16s ease}.day-cell span{position:relative;z-index:1;line-height:1}.day-cell.muted{color:#b7b1be;background:rgba(255,255,255,.42)}.day-cell.today{box-shadow:inset 0 0 0 1px rgba(var(--blue-rgb),.42)}.day-cell.selected{color:#fff;background:linear-gradient(135deg,#d08caf,#78a9d3);box-shadow:0 11px 21px rgba(126,111,160,.23)}.day-cell.has-todos::after{content:"";position:absolute;left:50%;bottom:5px;width:4px;height:4px;border-radius:50%;background:var(--pink);transform:translateX(-50%)}.day-cell.selected::after{background:#fff}.day-cell i{position:absolute;right:2px;top:2px;min-width:12px;height:12px;display:grid;place-items:center;border-radius:999px;color:#fff;background:#78a9d3;font-size:7px;font-style:normal;font-weight:800;line-height:1;box-shadow:0 2px 6px rgba(103,96,132,.16)}.day-cell.selected i{color:#7e6d91;background:#fff}
