...
.memory-overview>header{position:relative;z-index:1;display:flex;align-items:center}.memory-overview>header span{display:flex;align-items:center;gap:5px;color:rgba(255,255,255,.68);font-size:7px;font-weight:800;letter-spacing:.13em}
.overview-core{position:relative;z-index:1;display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:12px;margin-top:10px}.overview-number{min-width:54px;display:grid;justify-items:center}.overview-number strong{color:#fff;font-family:Georgia,serif;font-size:38px;font-weight:500;line-height:.95;letter-spacing:-.05em;text-shadow:0 3px 14px rgba(50,44,72,.18)}.overview-number span{margin-top:4px;color:rgba(255,255,255,.62);font-size:7px}.overview-copy{min-width:0}.overview-copy h1{margin:0;color:#fff;font-size:18px;letter-spacing:-.045em;text-shadow:0 2px 12px rgba(52,45,72,.15)}.overview-copy p{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:2;margin:5px 0 0;color:rgba(255,255,255,.7);font-size:8px;line-height:1.55}.overview-mark{width:43px;height:43px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.22);border-radius:16px;color:rgba(255,255,255,.9);background:linear-gradient(135deg,rgba(255,255,255,.19),rgba(255,255,255,.07));box-shadow:inset 0 1px rgba(255,255,255,.24),0 9px 20px rgba(50,44,72,.12);backdrop-filter:blur(10px)}
.memory-overview>footer{position:relative;z-index:1;min-height:27px;display:flex;align-items:center;justify-content:space-between;margin-top:11px;padding:0 4px 0 9px;border:1px solid rgba(255,255,255,.08);border-radius:10px;color:rgba(255,255,255,.7);background:rgba(255,255,255,.08);font-size:7px}.memory-overview>footer.pending{color:rgba(255,255,255,.82);background:rgba(255,226,241,.11)}.memory-overview>footer b{min-width:21px;height:21px;display:grid;place-items:center;padding:0 6px;border-radius:999px;color:#718c83;background:rgba(244,255,251,.88);font-size:7px}.memory-overview>footer.pending b{color:#9a6f91;background:rgba(255,244,251,.92)}
.memory-search{height:46px;display:flex;align-items:center;gap:9px;margin-top:13px;padding:0 12px;border:1px solid rgba(255,255,255,.84);border-radius:16px;color:#9b94a5;background:rgba(255,255,255,.61);box-shadow:0 9px 26px rgba(75,70,103,.06);backdrop-filter:blur(16px)}.memory-search input{min-width:0;flex:1;padding:0;border:0;outline:0;color:var(--ink);background:transparent;font-size:11px}.memory-search input::-webkit-search-cancel-button{display:none}.memory-search button{width:29px;height:29px;display:grid;place-items:center;padding:0;border:0;border-radius:10px;color:#9c95a5;background:rgba(109,101,130,.06)}
.memory-tabs{display:grid;grid-template-columns:repeat(3,1fr);gap:5px;margin:11px 0 15px;padding:4px;border-radius:16px;background:rgba(111,103,136,.065)}.memory-tabs button{min-width:0;height:38px;display:flex;align-items:center;justify-content:center;gap:6px;padding:0 6px;border:0;border-radius:12px;color:#8c8696;background:transparent;font-size:9px;font-weight:700}.memory-tabs button b{min-width:18px;height:18px;display:grid;place-items:center;padding:0 5px;border-radius:999px;color:#9a93a3;background:rgba(255,255,255,.65);font-size:7px}.memory-tabs button.active{color:#655d75;background:rgba(255,255,255,.87);box-shadow:0 7px 18px rgba(86,79,112,.09)}.memory-tabs button.active b{color:#fff;background:linear-gradient(135deg,#ca88ac,#829bc7)}
.memory-error{margin:0 0 11px;padding:10px 12px;border-radius:13px;color:#aa5970;background:rgba(221,112,139,.1);font-size:9px;line-height:1.5;text-align:center}
...
.memory-card header{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:10px}.memory-symbol{width:36px;height:36px;display:grid;place-items:center;border:1px solid rgba(var(--blue-rgb),.18);border-radius:13px;color:#779bc0;background:linear-gradient(145deg,rgba(var(--blue-rgb),.11),rgba(255,255,255,.55))}.candidate .memory-symbol{color:#ad7397;border-color:rgba(var(--pink-rgb),.2);background:linear-gradient(145deg,rgba(var(--pink-rgb),.13),rgba(255,255,255,.58))}.memory-heading{min-width:0;display:grid;gap:3px}.memory-heading strong{font-size:10px}.memory-heading span{overflow:hidden;color:var(--muted);font-size:7px;text-overflow:ellipsis;white-space:nowrap}.memory-card header em{padding:4px 7px;border-radius:999px;color:#6f9b8b;background:rgba(97,180,146,.1);font-size:7px;font-style:normal;font-weight:700}.memory-card.candidate header em{color:#a66e90;background:rgba(var(--pink-rgb),.11)}
.memory-card h2{margin:13px 2px 0;color:#4b4657;font-size:13px;font-weight:650;line-height:1.7;letter-spacing:-.01em}.memory-card blockquote{margin:12px 0 0;padding:10px 11px;border:0;border-radius:14px;color:#817a89;background:rgba(116,108,137,.05)}.memory-card blockquote span{display:block;margin-bottom:5px;color:#a17c98;font-size:7px;font-weight:700;letter-spacing:.08em}.memory-card blockquote p{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:3;margin:0;font-size:9px;line-height:1.65}
.memory-card footer{margin-top:12px}.confidence-copy{display:flex;align-items:center;justify-content:space-between;color:#9a94a3;font-size:7px}.confidence-copy b{color:#817a8b;font-size:8px}.confidence-track{height:3px;overflow:hidden;margin-top:5px;border-radius:99px;background:rgba(109,101,130,.07)}.confidence-track i{height:100%;display:block;border-radius:inherit;background:linear-gradient(90deg,rgba(var(--pink-rgb),.72),rgba(var(--blue-rgb),.8))}
.memory-actions{display:grid;grid-template-columns:.8fr 1.2fr;gap:7px;margin-top:13px}.memory-actions button{height:39px;display:flex;align-items:center;justify-content:center;gap:6px;border:0;border-radius:13px;color:#9b6d7b;background:rgba(var(--pink-rgb),.09);font-size:9px;font-weight:700}.memory-actions button:last-child{color:#fff;background:linear-gradient(120deg,#c986ad,#8798c5 58%,#76a8cf);box-shadow:0 10px 22px rgba(126,105,155,.19)}.memory-actions button:disabled{opacity:.55}
</style>
