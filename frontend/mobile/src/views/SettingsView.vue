...
.ai-model-kind-tabs{display:flex;gap:7px;overflow-x:auto;margin:0 1px 10px;padding:1px 1px 3px;scrollbar-width:none}.ai-model-kind-tabs::-webkit-scrollbar{display:none}.ai-model-kind-tabs button{display:flex;align-items:center;gap:5px;flex:0 0 auto;padding:7px 9px;border:1px solid rgba(112,104,137,.1);border-radius:999px;color:#827a8b;background:rgba(255,255,255,.7);font-size:calc(7px * var(--font-scale,1));font-weight:750;white-space:nowrap}.ai-model-kind-tabs button b{min-width:17px;padding:2px 5px;border-radius:999px;color:#9a91a3;background:rgba(112,104,137,.07);font-size:calc(6px * var(--font-scale,1));text-align:center}.ai-model-kind-tabs button.active{border-color:rgba(126,144,186,.24);color:#6c6e98;background:linear-gradient(125deg,rgba(var(--pink-rgb),.12),rgba(var(--blue-rgb),.15))}.ai-model-kind-tabs button.active b{color:#716c94;background:rgba(255,255,255,.58)}.ai-model-picker-error{display:flex;align-items:center;gap:6px;margin:0 2px 9px;padding:8px 10px;border-radius:11px;color:#a65f72;background:rgba(202,103,132,.09);font-size:calc(7px * var(--font-scale,1));line-height:1.4}.ai-model-picker-error svg{flex:0 0 auto}
