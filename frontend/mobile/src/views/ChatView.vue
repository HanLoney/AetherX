...
.message-bubble { position:relative; max-width:min(82%,510px); overflow:hidden; padding:12px 14px; border:1px solid rgba(255,255,255,.7); border-radius:7px 22px 22px 22px; color:#4e495e; background:linear-gradient(145deg,rgba(255,255,255,.58),rgba(255,255,255,.28)); box-shadow:inset 0 1px 0 rgba(255,255,255,.86),inset 0 -1px 0 rgba(107,96,129,.06),0 12px 32px rgba(73,69,96,.09); backdrop-filter:blur(26px) saturate(165%); -webkit-backdrop-filter:blur(26px) saturate(165%); font-size:13px; line-height:1.72; white-space:pre-wrap; overflow-wrap:anywhere; }
...
.user .message-bubble { border-color:rgba(255,255,255,.36); border-radius:22px 7px 22px 22px; color:#fff; background:linear-gradient(135deg,rgba(204,126,171,.84),rgba(125,139,190,.82) 58%,rgba(91,159,211,.78)); box-shadow:inset 0 1px 0 rgba(255,255,255,.42),0 12px 30px rgba(115,96,151,.2); }
...
.chat-error { width:calc(100% - 14px);margin:0 auto 7px;padding:9px 12px;border:1px solid rgba(255,255,255,.66);border-radius:16px;color:#b95770;background:rgba(255,235,243,.56);font-size:10px;text-align:center;box-shadow:0 8px 24px rgba(95,70,90,.1);backdrop-filter:blur(24px)}
