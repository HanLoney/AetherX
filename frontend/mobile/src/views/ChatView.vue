...
.message-bubble { position:relative; max-width:min(82%,510px); overflow:hidden; padding:12px 14px; border:1px solid rgba(255,255,255,.7); border-radius:22px 22px 22px 7px; color:#4e495e; background:linear-gradient(145deg,rgba(255,255,255,.58),rgba(255,255,255,.28)); box-shadow:inset 0 1px 0 rgba(255,255,255,.86),inset 0 -1px 0 rgba(107,96,129,.06),0 12px 32px rgba(73,69,96,.09); backdrop-filter:blur(26px) saturate(165%); -webkit-backdrop-filter:blur(26px) saturate(165%); font-size:13px; line-height:1.72; white-space:pre-wrap; overflow-wrap:anywhere; }
